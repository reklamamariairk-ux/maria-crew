...
export async function handleStart(ctx: BotContext): Promise<void> {
  ...
  await send(
    ...
    'Это программа мотивации сотрудников кондитерских «Мария».\n\n' +
    '🃏 <b>Карточки героев</b> — за хорошую работу каждый месяц\n' +
    '💰 <b>Монеты</b> — за чек-листы, отзывы и активность\n' +
    '🎁 <b>Призы</b> — торт, сертификаты и денежная премия\n\n' +
    'Нажми кнопку ниже, выбери свою точку и начни копить! 👇',
    kb
  );
}
